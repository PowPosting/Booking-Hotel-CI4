...
<script>
// Function untuk membuka room detail modal
function openRoomDetail(roomType, roomName, price, description, image) {
    // Set modal content
    document.getElementById('modalRoomTitle').textContent = roomName;
    document.getElementById('modalRoomPrice').textContent = 'Rp ' + new Intl.NumberFormat('id-ID').format(price) + '/malam';
    document.getElementById('modalRoomDesc').textContent = description;
    
    // Set images
    const baseImagePath = '<?= base_url('images/') ?>';
    document.getElementById('modalRoomImg1').src = baseImagePath + image;
    document.getElementById('modalRoomImg2').src = baseImagePath + image;
    document.getElementById('modalRoomImg3').src = baseImagePath + image;
